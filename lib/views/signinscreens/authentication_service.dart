...
class AuthService {
  ...
  Future<bool> initAuth() async {
    final storedRefreshToken =
        await _secureStorage.read(key: AppConstants.REFRESH_TOKEN_KEY);
    ...
    try {
      ...
      result = await _appAuth.token(
        TokenRequest(
          ...
          issuer: AppConstants.GOOGLE_ISSUER,
    ...
    if (isValidResult) {
      ...
      if (result.refreshToken != null) {
        await _secureStorage.write(
          key: AppConstants.REFRESH_TOKEN_KEY,
      ...
      if (backendToken != null) {
        await _secureStorage.write(
          key: AppConstants.BACKEND_TOKEN_KEY,
          value: backendToken,
        );
      }
      return true;
