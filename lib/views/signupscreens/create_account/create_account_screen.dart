...
class CreateAccountScreenState extends State<CreateAccountScreen> {
              ...
              children: [
                ...
                Column(
                  children: [
                    ...
                    selectProfileFor(context, state)
                  ],
                ),
                SizedBox(
                  height: 24,
                        ...
                        children: [
                          Transform.scale(
                            ...
                            child: Radio(
                                ...
                                onChanged: (val) {
                                  if (state.profileCreatedFor ==
                                          Relationship.Daughter ||
                                      state.profileCreatedFor ==
                                          Relationship.Sister) {
                                    return;
                                  }
                ...
                Container(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                          ...
                          prefixIcon: countrySelector(state)),
                    )),
                SizedBox(
                  height: 24,
                ),
  ...
  Widget countrySelector(CreateAccountInitialState state) {
    return InkWell(
      onTap: () {
        showCountryPicker(
            context: context,
      ...
      child: Container(
        ...
        child: Row(
          ...
          //mainAxisAlignment: MainAxisAlignment.start,
          children: [
            Text(AppHelper.countryCodeToEmoji(
  ...
  Container selectProfileFor(
      BuildContext context, CreateAccountInitialState state) {
    return Container(
      height: 44,
      ...
      child: Material(
        ...
        child: InkWell(
          onTap: () {
            showProfileForBottomSheet(state);
          },
          child: Row(
            children: [
              SizedBox(
  ...
  void showProfileForBottomSheet(CreateAccountInitialState state) async {
    var result = await showModalBottomSheet(
        isScrollControlled: true,
        backgroundColor: Colors.transparent,
        context: context,
        builder: (context) => ProfileCreateForBottomSheet(
              selectedRelation: state.profileCreatedFor,
            ));
