...
import 'package:makemymarry/views/profilescreens/family/family_background/family_background_bloc.dart';
    ...
    return BlocConsumer<AboutBloc, AboutState>(
      ...
      builder: (context, state) {
        ...
        if (state is OnLoading) {
          return Scaffold(body: MmmWidgets.buildLoader2(context));
        }
              ...
              child: Container(
                  ...
                  child:
                    ...
                    children: [
                      ...
                      SizedBox(height: 20),
                      BlocConsumer<FamilyBackgroundBloc,
                              familyBackgroundState.FamilyBackgroundState>(
                          listener: (context, state) {
                        // TODO: implement listener
                      }, builder: (context, state) {
                        if (state is familyBackgroundState
                            .FamilyBackgroundInitialState) {
                          BlocProvider.of<FamilyBackgroundBloc>(context)
                              .add(onFamilyBackgroundDataLoad(basicUserId!));
                        }
                        if (state is familyBackgroundState
