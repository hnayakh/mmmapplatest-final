...
class ReligionBottomSheet extends StatefulWidget {
  ...
  const ReligionBottomSheet({Key? key, this.selected, required this.list})
      : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return ReligionBottomSheetState();
  }
}

class ReligionBottomSheetState extends State<ReligionBottomSheet> {
