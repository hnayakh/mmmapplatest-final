...
class GothraFilterBottomSheet extends StatefulWidget {
  final dynamic selected;
  final List<dynamic> list;

  const GothraFilterBottomSheet(
      {Key? key, required this.selected, required this.list})
      : super(key: key);

  @override
  _GothraFilterBottomSheetState createState() =>
      _GothraFilterBottomSheetState();
}

class _GothraFilterBottomSheetState extends State<GothraFilterBottomSheet> {
