...
class ReligonFilterBottomSheet extends StatefulWidget {
  final SimpleMasterData? selected;
  final List<SimpleMasterData> list;
  const ReligonFilterBottomSheet(
      {Key? key, required this.selected, required this.list})
      : super(key: key);

  @override
  _ReligonFilterBottomSheetState createState() =>
      _ReligonFilterBottomSheetState();
}

class _ReligonFilterBottomSheetState extends State<ReligonFilterBottomSheet> {
